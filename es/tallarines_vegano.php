...
<head>
  <meta charset="utf-8" />
  <title>Tallarines Vegano - Misslaura</title>
...
<body>
  ...
  <div class="swiper mySwiper">
    <div class="swiper-wrapper">
      ...
      $pastaEspecifica = './../assets/images/img-es/tallarines_vegano/';
      ...
      foreach ($imagens as $index => $imagem) {
        ...
        echo '<img class="main-image" src="' . $pastaEspecifica . $imagem . '" alt="Tallarines Vegano" />';
        echo '</div>';
        echo '</div>';
      }
      ?>

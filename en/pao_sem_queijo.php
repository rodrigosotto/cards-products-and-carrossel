...
<head>
  <meta charset="utf-8" />
  <title>Pão Sem Queijo- Misslaura</title>
...
<body>
  ...
  <div class="swiper mySwiper" id="vertical">
    <div class="swiper-wrapper">
      ...
      $pastaEspecifica = './../assets/images/img-en/pao_sem_queijo/';
      ...
      foreach ($imagens as $index => $imagem) {
        ...
        echo '<img class="main-image" src="' . $pastaEspecifica . $imagem . '" alt="Pão Sem Queijo" />';
        echo '</div>';
        echo '</div>';
      }
      ?>
  ...
  <div class="row d-flex justify-content-center align-items-center mb-5">
    <a href="<?php echo '/p3d/?lang=en&pagina=1'; ?>" class="btn-voltar">See All Products</a>
  </div>
  <!-- Rodapé fixo -->
